          ...
          <Grid item key={video.id} xs={12} sm={6} md={4}>
            <Card className={classes.card}>
              <CardMedia
                ...
                image='https://images.unsplash.com/photo-1676049938043-def72f6b3cae?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwxfDB8MXxyYW5kb218MHx8fHx8fHx8MTY3NjQ0OTgxNA&ixlib=rb-4.0.3&q=80&w=1080'
                title='Image title'
              />
